...
class BaseWriterTest(object):
    ...
    def test_write_current_node_and_descendents(self):
        self.builder.anchor_element.write(self.iostr)
    ...
    def test_write_utf8_by_default(self):
        ...
        self.builder.anchor_element.doc_write(self.iostr)
    ...
    def test_write_latin1(self):
        ...
        self.builder = (
            self.my_builder('DocRoot')
                ...
                .element('Elem2'))
        self.builder.anchor_element.doc_write(self.iostr, encoding='latin1')
        self.assertEqual(
    ...
    def test_with_no_encoding(self):
        ...
        self.builder.anchor_element.doc_write(self.iostr, encoding=None)
